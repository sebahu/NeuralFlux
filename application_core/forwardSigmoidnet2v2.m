function output = forwardSigmoidnet2v2(NNs_per_MID_and_tp,mu_per_MID_and_tp,sigma_per_MID_and_tp,X_in, x_selectors_per_mid)
...
for mid_i = 1:num_mids
    for tp_i = 1:num_tps
        ...
        X = X_in(x_selectors_per_mid(mid_i,:)) - mu;
        X= X./sigma;
        X(mu==0 & sigma==0)=0;
